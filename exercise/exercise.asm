...
Mx0XPos	byte		; sprite X coordinate
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	lda #40
	sta P0XPos		; initialize player X min coordinate
	
	lda #80
	sta Mx0XPos		; initialize player X max coordinate
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	REPEAT 3
		sta WSYNC 	; frist three VSYNC scanlines
	REPEND
	lda #0
...
;; Here we area using 2WSYNCs (2 lines) of our 37 VBLANK lines
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	lda P0XPos		; load register A with desired X position
	and #$7f		; same as AND 011111111, forces bit 7 to zero
				; keeping the result positive

	sta WSYNC		; wai for next scanline
	sta HMCLR		; clear old horizontal position values
	
	sec			; set carry flag before subtraction
DividedLoop:
	sbc #15			; A -= 15
	bcs DividedLoop		; loop while carry flag is still set
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;; Let the TIA output the 35 remained lines of VBLANK (37-2)
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	REPEAT 35
		sta WSYNC
	REPEND
...
DrawBitmap:
	...
	sta GRP0		; set graphcs for player 0 slice
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	...
	cmp Mx0XPos		; compare the value with 80
